...
class CocoDataset(utils.Dataset):
    ...
    def load_mask(self, image_id):
        ...
        for annotation in annotations:
            start_row, start_col, end_row, end_col = annotation["start_row"], annotation["start_col"], \
                                                     annotation["end_row"], annotation["end_col"]
            ...
            if class_id:
                ...
                tab_struct.append([start_row, start_col, end_row, end_col])
        ...
        if class_ids:
            ...
            return mask, class_ids, tab_struct
        else:
